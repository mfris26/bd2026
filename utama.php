...
<head>
    ...
    <title>Input Data Mahasiswa - SIAKAD</title>
    <style>
        body {
        ...
        .page-title {
            font-size: 22px;
            color: #2c3e50;
            margin-bottom: 5px; /* Dikecilkan sedikit agar jarak ke tanggal pas */
            font-weight: 600;
            border-bottom: 2px solid #1e5631;
            padding-bottom: 8px;
            display: inline-block;
        }
        /* Styling tambahan untuk membungkus info tanggal */
        .date-info {
            font-size: 14px;
            color: #666;
            margin-top: 5px;
    ...
    <tr>
        ...
        <td class="main-content">
            ...
            if (isset($_POST['submit'])) {
                ...
                // Menjalankan query INSERT menggunakan NIM dan Nama yang asli dari inputan user
                $query = "INSERT INTO tbl_mhs (nim, namamhs) VALUES ('$nim', '$namamhs')";
                
                if (mysqli_query($link, $query)) {
                    echo "<div class='alert alert-success'><b>Sukses!</b> Mahasiswa bernama <strong>$namamhs</strong> ($nim) berhasil disimpan.</div>";
                } else {
            ...
            <form action="" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="nim" name="nim" class="form-control" placeholder="Contoh: 231011..." required autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="namamhs">Nama Lengkap Anda :</label>
                    <input type="text" id="id_nama" name="namamhs" class="form-control" placeholder="Masukkan nama lengkap..." required autocomplete="off">
                </div>
